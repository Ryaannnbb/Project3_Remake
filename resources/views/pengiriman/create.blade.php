                            ...
                            <div class="table-responsive p-0">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select  @error('pesanan') is-invalid @enderror" name="pesanan"
                                            type="text" value="{{ old('pesanan') }}" id="example-text-input">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_pengiriman') is-invalid @enderror" name="tanggal_pengiriman">

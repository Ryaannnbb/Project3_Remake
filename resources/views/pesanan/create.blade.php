              ...
              <div class="table-responsive p-0">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input class="form-control  @error('nama_supplier') is-invalid @enderror" name="nama_supplier"
                      type="text"  value="{{ old('nama_supplier') }}"
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control  @error('alamat_supplier') is-invalid @enderror" name="alamat_supplier"
                      type="text" value="{{ old('alamat_supplier') }}"
                      id="example-text-input">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control  @error('nomor_telepon_supplier') is-invalid @enderror"
                      ...
                      value="{{ old('nomor_telepon_supplier') }}" id="example-text-input">

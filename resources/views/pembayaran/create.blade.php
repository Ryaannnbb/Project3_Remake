                        ...
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                ...
                                <div class="ms-auto d-flex">
                                    <button type="submit" action="{{ route('pembayaran.store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control  @error('metode_pembayaran') is-invalid @enderror"
                                            name="metode_pembayaran" type="text" value="{{ old('metode_pembayaran') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control  @error('no_rekening') is-invalid @enderror"
                                            name="no_rekening" type="number" value="{{ old('no_rekening') }}"
                                            id="example-text-input">
                                        @error('no_rekening')
                                            <div class="invalid-feedback">
                                                {{ $message }}

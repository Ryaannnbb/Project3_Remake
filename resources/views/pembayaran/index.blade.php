                                    ...
                                    @if ($pembayaran->count() > 0)
                                        @foreach ($pembayaran as $pb)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $pb->metode_pembayaran }}</span>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $pb->no_rekening }}</span>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    ...
                                                    <form id="deleteform{{ $pb->id }}" method="POST"
                                                        action="{{ route('pembayaran.destroy', $pb->id) }}"

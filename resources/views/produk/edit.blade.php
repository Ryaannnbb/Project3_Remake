                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input class="form-control @error('path_produk') is-invalid @enderror"
                                                    name="path_produk" id="imageInput" type="file"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('nama_produk') is-invalid @enderror"
                                            name="nama_produk" type="text" placeholder="Product Name"
                                            value="{{ $produk->nama_produk }}" id="example-text-input">
                                        @error('nama_produk')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('harga') is-invalid @enderror" name="harga"
                                            type="number" placeholder="Price" value="{{ $produk->harga }}"
                                            id="example-text-input">
                                        @error('harga')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control  @error('stok') is-invalid @enderror" name="stok"
                                            type="number" value="{{ $produk->stok }}" id="example-text-input">
                                        @error('stok')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('kategori_id') is-invalid @enderror"
                                            name="kategori_id" type="text" placeholder="Category Name"
                                            id="example-text-input">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('supplier_id') is-invalid @enderror"
                                            name="supplier_id" type="text" placeholder="Supplier"
                                            id="example-text-input">

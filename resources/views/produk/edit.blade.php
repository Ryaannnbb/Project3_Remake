              ...
              <div class="table-responsive p-0">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                        <div class="col">
                            <label for="imageInput" class="form-control-label">Product Image</label>
                            <input class="form-control @error('path_produk') is-invalid @enderror" name="path_produk" id="imageInput" type="file" id="example-text-input">
                            @error('path_produk')
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset(old('path_produk', $produk->path_produk)) }}" id="preview-image" alt="Current Product Photo" class="w-100">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" type="text" placeholder="Description" id="example-text-input">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>

            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <h5 class="font-weight-black text-dark display-6 mt-3">Welcome to our Pet Shop! We provide a wide
                            range of
                            products and services for your beloved pets. Discover high-quality products and the best
                            services for your
                                    ...
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="{{ asset($pd->path_produk) }}">
                                            <ul class="product__item__pic__hover">
                                                <li><a href="{{ route('shop.detail', $pd->id) }}"><i
